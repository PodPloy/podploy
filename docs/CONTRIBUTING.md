...
| **[GolangCI-Lint](https://golangci-lint.run/)**                         | `v1.55+`    | Linter                      | `curl -sSfL https://golangci-lint.run/install.sh      | sh -s v2.9.0` |
...
| :---------- | :----------------- | :--------------------------------------------------------------------- | :------------------- |
| **Domain**  | `internal/domain`  | Entities (Structs), Repository Interfaces, Custom Errors. **Pure Go.** | _Nothing_            |
