...
// AddMembershipIDs adds the "memberships" edge to the OrganizationMember entity by ids.
func (m *RoleMutation) AddMembershipIDs(ids ...uuid.UUID) {
	if m.memberships == nil {
		m.memberships = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// RemoveMembershipIDs removes the "memberships" edge to the OrganizationMember entity by IDs.
func (m *RoleMutation) RemoveMembershipIDs(ids ...uuid.UUID) {
	if m.removedmemberships == nil {
		m.removedmemberships = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// RemovedMemberships returns the removed IDs of the "memberships" edge to the OrganizationMember entity.
func (m *RoleMutation) RemovedMembershipsIDs() (ids []uuid.UUID) {
	for id := range m.removedmemberships {
		ids = append(ids, id)
	}
	return
...
// MembershipsIDs returns the "memberships" edge IDs in the mutation.
func (m *RoleMutation) MembershipsIDs() (ids []uuid.UUID) {
	for id := range m.memberships {
		ids = append(ids, id)
	}
	return
...
// AddMembershipIDs adds the "memberships" edge to the OrganizationMember entity by ids.
func (m *UsersMutation) AddMembershipIDs(ids ...uuid.UUID) {
	if m.memberships == nil {
		m.memberships = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// RemoveMembershipIDs removes the "memberships" edge to the OrganizationMember entity by IDs.
func (m *UsersMutation) RemoveMembershipIDs(ids ...uuid.UUID) {
	if m.removedmemberships == nil {
		m.removedmemberships = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// RemovedMemberships returns the removed IDs of the "memberships" edge to the OrganizationMember entity.
func (m *UsersMutation) RemovedMembershipsIDs() (ids []uuid.UUID) {
	for id := range m.removedmemberships {
		ids = append(ids, id)
	}
	return
...
// MembershipsIDs returns the "memberships" edge IDs in the mutation.
func (m *UsersMutation) MembershipsIDs() (ids []uuid.UUID) {
	for id := range m.memberships {
		ids = append(ids, id)
	}
	return
