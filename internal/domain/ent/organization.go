...
func (_m *Organization) NamedRoles(name string) ([]*Role, error) {
...
func (_m *Organization) appendNamedRoles(name string, edges ...*Role) {
	if _m.Edges.namedRoles == nil {
...
// loaded in eager-loading with this name.
func (_m *Organization) NamedMemberships(name string) ([]*OrganizationMember, error) {
...
func (_m *Organization) appendNamedMemberships(name string, edges ...*OrganizationMember) {
	if _m.Edges.namedMemberships == nil {
