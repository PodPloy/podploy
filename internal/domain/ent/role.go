...
func (e RoleEdges) MembershipsOrErr() ([]*OrganizationMember, error) {
	if e.loadedTypes[1] {
...
func (_m *Role) QueryMemberships() *OrganizationMemberQuery {
	return NewRoleClient(_m.config).QueryMemberships(_m)
}
...
func (_m *Role) NamedMemberships(name string) ([]*OrganizationMember, error) {
...
func (_m *Role) appendNamedMemberships(name string, edges ...*OrganizationMember) {
	if _m.Edges.namedMemberships == nil {
