...
func (_q *RoleQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *RoleQuery) QueryMemberships() *OrganizationMemberQuery {
...
func (_q *RoleQuery) WithOrganization(opts ...func(*OrganizationQuery)) *RoleQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
...
func (_q *RoleQuery) WithMemberships(opts ...func(*OrganizationMemberQuery)) *RoleQuery {
	query := (&OrganizationMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *Role) { n.Edges.Memberships = []*OrganizationMember{} },
			func(n *Role, e *OrganizationMember) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
	...
	for name, query := range _q.withNamedMemberships {
		if err := _q.loadMemberships(ctx, query, nodes,
			...
			func(n *Role, e *OrganizationMember) { n.appendNamedMemberships(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *RoleQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Role, init func(*Role), assign func(*Role, *Organization)) error {
...
func (_q *RoleQuery) loadMemberships(ctx context.Context, query *OrganizationMemberQuery, nodes []*Role, init func(*Role), assign func(*Role, *OrganizationMember)) error {
...
func (_q *RoleQuery) WithNamedMemberships(name string, opts ...func(*OrganizationMemberQuery)) *RoleQuery {
	query := (&OrganizationMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *RoleQuery) WithNamedPermissions(name string, opts ...func(*PermissionQuery)) *RoleQuery {
	query := (&PermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
