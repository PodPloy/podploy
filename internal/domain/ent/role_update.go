...
func (_u *RoleUpdate) AddMembershipIDs(ids ...uuid.UUID) *RoleUpdate {
...
func (_u *RoleUpdate) RemoveMembershipIDs(ids ...uuid.UUID) *RoleUpdate {
...
// AddMembershipIDs adds the "memberships" edge to the OrganizationMember entity by IDs.
func (_u *RoleUpdateOne) AddMembershipIDs(ids ...uuid.UUID) *RoleUpdateOne {
	_u.mutation.AddMembershipIDs(ids...)
	return _u
}
...
// RemoveMembershipIDs removes the "memberships" edge to OrganizationMember entities by IDs.
func (_u *RoleUpdateOne) RemoveMembershipIDs(ids ...uuid.UUID) *RoleUpdateOne {
	_u.mutation.RemoveMembershipIDs(ids...)
	return _u
}
