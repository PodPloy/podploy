...
type UsersEdges struct {
	...
	namedMemberships map[string][]*OrganizationMember
}

// MembershipsOrErr returns the Memberships value or an error if the edge
// was not loaded in eager-loading.
func (e UsersEdges) MembershipsOrErr() ([]*OrganizationMember, error) {
	if e.loadedTypes[0] {
...
func (*Users) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case users.FieldEmail, users.FieldPasswordHash, users.FieldFullName:
...
// QueryMemberships queries the "memberships" edge of the Users entity.
func (_m *Users) QueryMemberships() *OrganizationMemberQuery {
	return NewUsersClient(_m.config).QueryMemberships(_m)
}
...
func (_m *Users) NamedMemberships(name string) ([]*OrganizationMember, error) {
...
func (_m *Users) appendNamedMemberships(name string, edges ...*OrganizationMember) {
	if _m.Edges.namedMemberships == nil {
		_m.Edges.namedMemberships = make(map[string][]*OrganizationMember)
	}
	if len(edges) == 0 {
		_m.Edges.namedMemberships[name] = []*OrganizationMember{}
	} else {
