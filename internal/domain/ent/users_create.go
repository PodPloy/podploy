...
func (_c *UsersCreate) AddMembershipIDs(ids ...uuid.UUID) *UsersCreate {
...
func (_c *UsersCreate) check() error {
	...
	if _, ok := _c.mutation.Active(); !ok {
		return &ValidationError{Name: "active", err: errors.New(`ent: missing required field "Users.active"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
