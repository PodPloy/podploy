...
type UsersQuery struct {
	...
	withNamedMemberships map[string]*OrganizationMemberQuery
...
func (_q *UsersQuery) QueryMemberships() *OrganizationMemberQuery {
...
func (_q *UsersQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UsersQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *UsersQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UsersQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *UsersQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *UsersQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UsersQuery) WithMemberships(opts ...func(*OrganizationMemberQuery)) *UsersQuery {
	query := (&OrganizationMemberClient{config: _q.config}).Query()
...
func (_q *UsersQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Users, error) {
	...
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *Users) { n.Edges.Memberships = []*OrganizationMember{} },
			func(n *Users, e *OrganizationMember) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedMemberships {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *Users) { n.appendNamedMemberships(name) },
			func(n *Users, e *OrganizationMember) { n.appendNamedMemberships(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UsersQuery) loadMemberships(ctx context.Context, query *OrganizationMemberQuery, nodes []*Users, init func(*Users), assign func(*Users, *OrganizationMember)) error {
	...
	query.Where(predicate.OrganizationMember(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(users.MembershipsColumn), fks...))
	}))
...
func (_q *UsersQuery) WithNamedMemberships(name string, opts ...func(*OrganizationMemberQuery)) *UsersQuery {
	query := (&OrganizationMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedMemberships == nil {
		_q.withNamedMemberships = make(map[string]*OrganizationMemberQuery)
	}
