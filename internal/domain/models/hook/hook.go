...
type OrganizationFunc func(context.Context, *models.OrganizationMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f OrganizationFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	if mv, ok := m.(*models.OrganizationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *models.OrganizationMutation", m)
}

// The OrganizationMemberFunc type is an adapter to allow the use of ordinary
// function as OrganizationMember mutator.
type OrganizationMemberFunc func(context.Context, *models.OrganizationMemberMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f OrganizationMemberFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	if mv, ok := m.(*models.OrganizationMemberMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *models.OrganizationMemberMutation", m)
}
...
func (f PermissionFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	if mv, ok := m.(*models.PermissionMutation); ok {
		return f(ctx, mv)
	}
...
type RoleFunc func(context.Context, *models.RoleMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f RoleFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	if mv, ok := m.(*models.RoleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *models.RoleMutation", m)
}
