...
func (_u *RoleUpdate) AddMembershipIDs(ids ...int) *RoleUpdate {
	_u.mutation.AddMembershipIDs(ids...)
	return _u
}

// AddMemberships adds the "memberships" edges to the OrganizationMember entity.
func (_u *RoleUpdate) AddMemberships(v ...*OrganizationMember) *RoleUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *RoleUpdate) check() error {
	if v, ok := _u.mutation.Name(); ok {
		if err := role.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`models: validator failed for field "Role.name": %w`, err)}
		}
	}
	return nil
}
...
// AddMembershipIDs adds the "memberships" edge to the OrganizationMember entity by IDs.
func (_u *RoleUpdateOne) AddMembershipIDs(ids ...int) *RoleUpdateOne {
	_u.mutation.AddMembershipIDs(ids...)
	return _u
}

// AddMemberships adds the "memberships" edges to the OrganizationMember entity.
func (_u *RoleUpdateOne) AddMemberships(v ...*OrganizationMember) *RoleUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearMemberships clears all "memberships" edges to the OrganizationMember entity.
func (_u *RoleUpdateOne) ClearMemberships() *RoleUpdateOne {
	_u.mutation.ClearMemberships()
	return _u
}

// RemoveMembershipIDs removes the "memberships" edge to OrganizationMember entities by IDs.
func (_u *RoleUpdateOne) RemoveMembershipIDs(ids ...int) *RoleUpdateOne {
	_u.mutation.RemoveMembershipIDs(ids...)
	return _u
}

// RemoveMemberships removes "memberships" edges to OrganizationMember entities.
func (_u *RoleUpdateOne) RemoveMemberships(v ...*OrganizationMember) *RoleUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`models: missing "Role.id" for update`)}
	}
