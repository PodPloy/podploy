...
func (_c *UsersCreate) SetActive(v bool) *UsersCreate {
	_c.mutation.SetActive(v)
	return _c
}

// SetNillableActive sets the "active" field if the given value is not nil.
func (_c *UsersCreate) SetNillableActive(v *bool) *UsersCreate {
	if v != nil {
		_c.SetActive(*v)
	}
	return _c
...
func (_c *UsersCreate) AddMembershipIDs(ids ...int) *UsersCreate {
	_c.mutation.AddMembershipIDs(ids...)
	return _c
}

// AddMemberships adds the "memberships" edges to the OrganizationMember entity.
func (_c *UsersCreate) AddMemberships(v ...*OrganizationMember) *UsersCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UsersCreate) check() error {
	...
	if _, ok := _c.mutation.FullName(); !ok {
		return &ValidationError{Name: "full_name", err: errors.New(`models: missing required field "Users.full_name"`)}
	}
	...
	if _, ok := _c.mutation.Active(); !ok {
		return &ValidationError{Name: "active", err: errors.New(`models: missing required field "Users.active"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
