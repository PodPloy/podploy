...
func (_u *UsersUpdate) AddMembershipIDs(ids ...int) *UsersUpdate {
...
func (_u *UsersUpdate) RemoveMembershipIDs(ids ...int) *UsersUpdate {
...
func (_u *UsersUpdate) check() error {
	if v, ok := _u.mutation.Email(); ok {
		if err := users.EmailValidator(v); err != nil {
			return &ValidationError{Name: "email", err: fmt.Errorf(`models: validator failed for field "Users.email": %w`, err)}
		}
	}
	if v, ok := _u.mutation.PasswordHash(); ok {
		if err := users.PasswordHashValidator(v); err != nil {
			return &ValidationError{Name: "password_hash", err: fmt.Errorf(`models: validator failed for field "Users.password_hash": %w`, err)}
		}
	}
	if v, ok := _u.mutation.FullName(); ok {
		if err := users.FullNameValidator(v); err != nil {
			return &ValidationError{Name: "full_name", err: fmt.Errorf(`models: validator failed for field "Users.full_name": %w`, err)}
		}
	}
	return nil
}
...
// AddMembershipIDs adds the "memberships" edge to the OrganizationMember entity by IDs.
func (_u *UsersUpdateOne) AddMembershipIDs(ids ...int) *UsersUpdateOne {
	_u.mutation.AddMembershipIDs(ids...)
	return _u
}
...
// RemoveMembershipIDs removes the "memberships" edge to OrganizationMember entities by IDs.
func (_u *UsersUpdateOne) RemoveMembershipIDs(ids ...int) *UsersUpdateOne {
	_u.mutation.RemoveMembershipIDs(ids...)
	return _u
}
